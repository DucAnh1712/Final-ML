...
def main():
    ...
    df_raw = df_raw.set_index('datetime', drop=False)
    ...
    # 5. Split Data (Preserving DatetimeIndex)
    ...
    # Print date ranges
    print(f"\n📅 Date Ranges:")
    # ✅ FIX: Now prints accurate date ranges using the DatetimeIndex
    ...
    # The first column in the CSV will be the 'datetime' index.
    ...
    # ✅ Updated script name for the next step based on user's change

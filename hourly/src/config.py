...
# ======================================================
# Predict the next 7 days: 24h (T+1d), 48h (T+2d), ..., 168h (T+7d)
...
CV_GAP_ROWS = CV_GAP_DAYS * 24 # ✅ IMPORTANT: 7 days * 24 hours = 168 row gap
...
TEST_METRICS_LINEAR_NAME = "test_metrics_linear_hourly.yaml" 
TEST_PREDS_LINEAR_NAME = "test_predictions_linear_hourly.csv" 
...
TEST_METRICS_LIGHTGBM_NAME = "test_metrics_lightgbm_hourly.yaml" 
TEST_PREDS_LIGHTGBM_NAME = "test_predictions_lightgbm_hourly.csv" 

# ======================================================
# OPTUNA FINE-TUNING
# ======================================================
# Reduced number of trials because hourly data is 24x larger
OPTUNA_TRIALS = 50

# Search space for Linear Models
LINEAR_PARAM_RANGES = {
...
# CLEARML
# ======================================================
CLEARML_PROJECT_NAME = "HCM Weather Forecasting (Hourly)" # ✅ Project name updated
# Task name will be set in each file (e.g., Linear Tuning, XGB Tuning...)